...
$(document).ready(function() {
	...
	if (windowWidth < 420) {
		$("#newAtlasTag").attr("src","//ad.atdmt.com/m/a.js;m=11082201078787;cache="+Math.random()+"?program="+Program+"&order_id="+OrderID+"&event=thankyoumobile");
	} else {
		$("#newAtlasTag").attr("src","//ad.atdmt.com/m/a.js;m=11082201078787;cache="+Math.random()+"?program="+Program+"&order_id="+OrderID+"&event=thankyoudesktop");
	}
