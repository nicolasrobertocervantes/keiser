...
<head>
  ...
  <title>Keiser University eCampus en Español | Maestría en Administración de Empresas</title>
...
<span class="contentSpacer"><br /></span><br />
    <h1>Maestría en Administración <span class="contentSpacer"><br /></span>de Empresas (MBA) <br />EN LÍNEA Y EN ESPAÑOL</h1>

    <p>El programa intensivo de <strong>Maestría en Administración de Empresas</strong> se dirige a los estudiantes que quieran incrementar sus conocimientos teóricos y prácticos sobre el mundo de negocios actual. Los estudiantes se especializan en:</p>

    <ul>
      <li>Liderazgo Gerencial</li>
      <li>Negocios Internacionales</li>
    </ul>

    <p>Los egresados de nuestro programa muestran un entendimiento conceptual en estrategias avanzadas de negocios y analizan críticamente problemas usando metodologías de investigación.</p>
