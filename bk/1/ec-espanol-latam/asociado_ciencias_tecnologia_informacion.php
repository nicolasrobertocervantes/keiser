...
<head>
  ...
  <title>Keiser University eCampus en Español - Asociado de Ciencias en Tecnología de la Información</title>
...
<body class="ascienciastecinformacion">
...
<section id="main" class="container">
  <section id="main-content" style="line-height:25px;">
    ...
    <h1>Asociado de <span class="contentSpacer"><br /></span>Ciencias en Tecnología<span class="contentSpacer"><br /></span>de la Información</h1>
    <br />
    <h2>Con especialización en Redes, Ciberseguridad y Programación.</h2>
    <h3 class="programasH3">Descripción del Programa</h3>
    <p>El programa de Asociado de Ciencias en Tecnología de la Información te preparará para puestos en la administración de redes con enfoque en el soporte de seguridad. Desarrollarás experiencia en la inspección de medidas de seguridad para proteger datos.</p>
    <p>Podrás especializarte en Redes, Ciberseguridad y Programación, donde recibirás una base sólida en el conocimiento, la teoría y la práctica de gestión de redes. Con un plan de estudios innovador, capacitación práctica y amplia, con exposición a las tecnologías modernas de la industria de la informática.</p>
    <br />
    <h3 class="programasH3">OBJETIVOS DEL PROGRAMA</h3>
    <p>En Keiser University el programa de te permitirá contribuir en el campo dinámico de la informática.</p>
    <p>Al completarlo, podrás:</p>
    <ul>
        <li>Administrar y solucionar problemas de hardware, software.</li>
        <li>Ser experto en conocimiento y la práctica de administración de redes.</li>
        <li>Estar preparado como especialistas de soporte técnico.</li>
        <li>Estar capacitado como administrador de sistemas de seguridad informática y protección de datos.</li>
        <li>Administrar servicios para entornos únicos, mixtos y de multiusuarios.</li>
    </ul>
    <a href="" title="" class="goform">Solicitar más información &gt;&gt;</a>
