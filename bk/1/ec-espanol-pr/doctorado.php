...
<head>
  ...
  <title>Keiser University eCampus en Español | Doctorados</title>
...
<span class="contentSpacer"><br /></span><br />
    <h1>Doctorado en Administración <span class="contentSpacer"><br /></span>de Empresas (DBA) <br />EN LÍNEA Y EN ESPAÑOL</h1>

    <p>El <strong>Doctorado en Administración de Negocios</strong> desarrolla las habilidades de profesionales de negocios y futuros miembros de la Academia para que apliquen teorías y métodos gerenciales, además de investigaciones que mejoran de forma dinámica las organizaciones y comunidades.</p>

    <p>El programa enfatiza el avance de nuevos conocimientos tanto en la teoría como en la investigación aplicada al ambiente global. El programa del Doctorado en Administración de Negocios promueve aptitudes para la toma de decisiones éticas y a conciencia, además la capacitación de liderar; fortalece el aprendizaje comprometido, la comunicación efectiva, la sustentabilidad y el uso de tecnologías de información en el entorno global de la administración empresarial.</p>

    <p>Los estudiantes del Doctorado pueden especializarse en una de las siguientes áreas:</p>
    <ul>
      <li>Gestión Global</li>
      <li>Negocio Global</li>
    </ul>
