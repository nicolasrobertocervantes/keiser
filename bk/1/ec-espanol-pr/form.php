<div id="form-container" class="sidebar">
        ...
        <div id="form-step-1">
          <select name="program" id="program" size="1">
            ...
            <option value="ASMASP-MIA-CAMPUS">Asociado en Ciencias de Asistencia Médica (Miami Campus)</option>
            ...
            <option value="BAHSAS">Bachillerato en Administración de Servicios de Salud</option>
            <option value="BABAS">Bachillerato en Administración de Empresas</option>
            <option value="BABAS-MKT">Bachillerato en Administración de Empresas con especialización en Mercadeo</option>
            <option value="BABASE">Bachillerato en Administración de Empresas con especialización en Emprendimiento</option>
            <option value="BABAS-FIN">Bachillerato en Administración de Empresas con especialización en Finanzas</option>
            <option value="BABAS-MAN">Bachillerato en Administración de Empresas con especialización en Gerencia</option>
            <option value="BABAS-MAN-MIA-CAMPUS">Bachillerato en Administración de Empresas con especialización en Gerencia (Miami Campus)</option>
            <option value="BABASHR">Bachillerato en Administración de Empresas con especialización en Recursos Humanos</option>
            <option value="BABAS-IBT">Bachillerato en Administración de Empresas con especialización en Negocios Internacionales</option>
            <option value="BAASP">Bachillerato en Contabilidad</option>
            <option value="BSISS">Bachillerato en Ciencias Interdisciplinarias</option>
            <option value="BAPSYSP">Bachillerato en Psicología</option>
            <option value="BSITMSP">Bachillerato en Gestión de Tecnologías de la Información</option>
        ...
        <div id="form-step-2">
          ...
          <select class="half l" name="state" id="state" style="width:48.5%;">
          ...
          <input class="half l" value="" name="phone_day" id="phone_day" type="text" placeholder="Tel&eacute;fono*">
        ...
        <div id="form-step-3">
            ...
            <!-- #newAtlasTag -->
            <img id="newAtlasTag" src="images/form-bg.png" style="display:none;" />
            <!-- KU-Rmkt-Tag -->
            <img src="//bat.bing.com/action/0?ti=5062364&Ver=2" height="0" width="0" style="display:none; visibility: hidden;" />
        </div><!-- / #form-step-3 -->
