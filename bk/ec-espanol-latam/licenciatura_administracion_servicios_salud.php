...
<head>
  ...
  <title>Keiser University eCampus en Español | Licenciatura en Administración de Servicios de Salud</title>
...
<span class="contentSpacer"><br /></span><br />
    <h1>Licenciatura en Administración <span class="contentSpacer"><br /></span>de Servicios de Salud <br />EN LÍNEA Y EN ESPAÑOL</h1>

    <p>La <strong>Licenciatura en Administración de Servicios de Salud</strong> ofrece un programa basado en los conocimientos fundamentales y las destrezas que todo administrador debe poseer. Entre estos conocimientos, el programa contempla especialmente la facturación con codificación y tópicos en el sector privado y público con relación a las finanzas y asuntos legales en el área de los servicios de salud.</p>
