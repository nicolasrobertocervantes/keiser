...
<body class="maestria_adm_empresas_gerencial">
...
<section id="main" class="container">
  <section id="main-content" style="line-height:25px;">
    ...
    <h1>Maestría en Administración de Empresas 
(MBA) - Gerencial <br />EN LÍNEA Y EN ESPAÑOL</h1>
    El MBA con orientación profesional de Keiser University prepara al estudiante para competir en el mundo moderno de los negocios. El curso general cubre disciplinas tales como métodos contemporáneos de gestión, marketing, negocios 
internacionales, sistemas de información de negocios, contabilidad y finanzas. El estudiante que busca especializarse en Management (Gerencia) obtendrá el 
conocimiento y las habilidades necesarias para avanzar en el entorno corporativo de hoy, desarrollando liderazgo, administración de recursos humanos, cambio 
organizacional, y mucho más.<br />
    <br />
    Adquiere tus estudios de MBA mientras continúas con tu trabajo. Todos los cursos son en línea, y te brindan la posibilidad de estudiar en cualquier momento y lugar. Nuestros graduados se distinguen por su habilidad para resolver problemas 
de actualidad en el mundo de los negocios.<br /><br />
    <span style="font-size:12px;">*Los candidatos deben poseer una Licenciatura para ingresar al programa.</span><br />
<br />
<a class="kuSections" href="programas.php">Programas MBA disponibles</a><br />
      <br /><br />
...
<span class="contentSpacer"><br /></span><br />
    <h2>Historias de &Eacute;xito</h2>
			<p class="quote">Sin duda, su guía e interés en mi 
aprovechamiento académico, fueron elementos claves para desarrollar en mí un compromiso solido con mis estudios."</p><p class="author">Eduardo J. P. Graduado del programa Licenciatura en Administración de Empresas.</p>
