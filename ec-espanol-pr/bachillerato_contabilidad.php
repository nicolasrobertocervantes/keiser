...
<section id="main" class="container">
  <section id="main-content" style="line-height:25px;">
    ...
    <h1>Bachillerato en Contabilidad <br />EN LÍNEA Y EN ESPAÑOL</h1><br />
    <h3 class="programasH3">Descripción del Programa</h3>
    El Bachillerato en Contabilidad de la Universidad de Keiser está enfocada 
    ...
    El Bachillerato en Contabilidad también utiliza varios programas de gestión 
    de negocios y de contabilidad.<br />
    <br /><br />
    <h3 class="programasH3">OBJETIVOS DEL PROGRAMA</h3>
    El Bachillerato en Contabilidad tiene como objetivo principal preparar a los 
