...
<head>
  ...
  <title>Keiser University eCampus en Español | ESOL</title>
...
<span class="contentSpacer"><br /></span><br />
    <h1>ESOL (Inglés para Hablantes de Otros Idiomas)</h1>
    <p>Keiser University ofrece el curso de <strong>ESOL (Inglés para Hablantes de Otros Idiomas)</strong>. No importa cuál sea tu nivel de inglés: Keiser tiene un curso con el nivel indicado para ti.  El curso se compone por 4 niveles de 8 semanas de duración cada uno, y uno de ellos es perfecto para ti.</p>

    <p>El curso de ESOL combina diferentes métodos de enseñanza como clases prácticas, dinámicas y apoyo tecnológico. Verás qué fácil es dominar el idioma internacional de los negocios.</p>

    <p><small style="font-size:12px !important;">Para obtener información sobre las tasas de graduación, los niveles de deuda estudiantil, u otra información, visita <a href="http://www.keiseruniversity.edu/consumerinfo/ESOL/Gedt.html" target="_blank">www.keiseruniversity.edu/consumerinfo/ESOL/Gedt.html</a></small></p>
