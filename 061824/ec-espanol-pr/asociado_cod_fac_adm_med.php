...
<body class="asociado_cod_fac_adm_med">
...
<section id="main" class="container">
  <section id="main-content" style="line-height:25px;">
    ...
    <h1>Asociado en Codificación <span class="contentSpacer"><br /></span>y Facturación Médica <br />EN LÍNEA Y EN ESPAÑOL</h1><br />
    <h3 class="programasH3">Descripción del Programa</h3>
    El programa en línea de Asociado en Codificación y Facturación Médica, otorgado por la Universidad de Keiser, prepara a los estudiantes para asignar códigos médicos precisos para los procedimientos de diagnóstico y otros servicios ofrecidos por profesionales en servicios de la salud. Los estudiantes aprenderán diversas funciones secretariales y administrativas que se relacionan con las reclamaciones de seguros, cumplimiento de procesos y reembolsos. Este programa preparará a nuestros graduados para tomar y pasar el examen otorgado por la Academia Americana de Codificadores Profesionales (AAPC), obteniendo sus credenciales como aprendices.<br />
    <br /><br />
    <h3 class="programasH3">OPORTUNIDADES DE CARRERA</h3>
    Los estudiantes que reciben un título de Asociado en Ciencias de Codificación y Facturación Médica estarán preparados para trabajar en:<br />
&bull; &nbsp; &nbsp; &nbsp; Consultorios particulares<br />
&bull; &nbsp; &nbsp; &nbsp; Enfermerías y centros residenciales de asistencia<br />
&bull; &nbsp; &nbsp; &nbsp; Organismos gubernamentales<br />
&bull; &nbsp; &nbsp; &nbsp; Hospitales<br />
<br />
Prepárate para comenzar hoy tu carrera en Codificación y Facturación Médica. Inscríbete en el programa de Asociado en Codificación y Facturación Médica de Keiser University. Contáctanos para más información.<br />
      <br /><br />
