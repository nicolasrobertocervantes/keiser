...
<head>
  ...
  <title>Keiser University eCampus en Español | Licenciatura en Administración de Empresas</title>
...
<span class="contentSpacer"><br /></span><br />
    <h1>Licenciatura en Administración <span class="contentSpacer"><br /></span>de Empresas <br />EN LÍNEA Y EN ESPAÑOL</h1>

    <p>El programa de estudios del título de <strong>Licenciado en Administración de Empresas</strong> le brinda a los estudiantes la oportunidad perfecta para avanzar en una carrera de negocios, ofreciéndoles educación comercial integral con cursos en administración, comercialización, finanzas, contabilidad, estadística y derecho.
    <br> Este programa resulta ideal para aquellos estudiantes que buscan adaptar sus estudios a un estilo de vida de múltiples obligaciones. El alumno puede elegir entre las siguientes especializaciones: </p>
    ...
    <p>Obtén una Licenciatura en Administración de Empresas en Línea y en español acreditada en EE.UU., ¡no importa en qué país vivas!</p>

    <p><small style="font-size:12px !important;">*Los candidatos deben poseer un diploma de secundaria (High School/GED) para ingresar al programa.</small></p>
...
<span class="contentSpacer"><br /></span><br />
    ...
    <h2>Historias de &Eacute;xito</h2>
			<p class="quote">Con el tiempo en mi estancia en Keiser University, pude percibir el calor humano por parte de todo el Profesorado, la Administración y la Dirección. "<span class="more">Y pude darme cuenta que no solo forman profesionistas, sino personas con un gran espíritu de servicio y experiencia para afrontar la vida. Muchas gracias Keiser University."</span></p><p class="author">Juan M. P. Graduado del programa de Licenciatura en Administración de Empresas</p>
