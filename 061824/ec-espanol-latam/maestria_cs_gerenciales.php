...
<head>
  ...
  <title>Keiser University eCampus en Español | Maestría en Ciencias Gerenciales</title>
...
<span class="contentSpacer"><br /></span><br />
    <h1>Maestría en Ciencias Gerenciales <br />EN LÍNEA Y EN ESPAÑOL</h1>

    <p>La <strong>Maestría en Ciencias Gerenciales</strong> de Keiser University prepara a los estudiantes para competir en el mundo gerencial y de liderazgo actual. El programa semestral de 33 créditos ha sido diseñado para estudiantes que desean desarrollar habilidades de liderazgo para supervisar y dirigir empleados en diferentes organizaciones. También está dirigido a profesionales que quieren asumir mayores responsabilidades gerenciales dentro de las organizaciones a las que pertenecen.</p>

    <p>El programa se enfoca en las siguientes áreas: destrezas de liderazgo, proceso de planificación e implementación estratégica, aspecto gerencial referido a los recursos humanos, comunicación gerencial y  desarrollo de otros líderes dentro de la organización.</p>

    <p><small>*Los candidatos deben poseer una Licenciatura para ingresar al programa. </small></p>
