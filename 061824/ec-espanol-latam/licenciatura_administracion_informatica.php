...
<head>
  ...
  <title>Keiser University eCampus en Español - Licenciatura en Ciencias en Gestión de Tecnologías de la Información</title>
...
<body class="licenciaturaadmininformatica">
...
<section id="main" class="container">
  <section id="main-content" style="line-height:25px;">
    ...
    <h1>Licenciatura en <span class="contentSpacer"><br /></span>Ciencias en Gestión<span class="contentSpacer"><br /></span>de Tecnologías de<span class="contentSpacer"><br /></span>la Información</h1>
    <br />
    <h3 class="programasH3">Descripción del Programa</h3>
    <p>Programa de terminación de grado (Track 1):</p>
    <p>El programa de terminación del título de Licenciatura en Ciencias en Gestión de Tecnologías de la Información está diseñado para preparar técnicos en informática que ya hayan obtenido un título de asociado en un campo relacionado con la informática para funciones como profesionales, supervisores y gerentes de tecnología de la información.</p>
    <p>
    En este programa, aprenderá conceptos comerciales fundamentales aplicables a la administración de la informática. Al mismo tiempo, aumentará su conocimiento del lado comercial de la tecnología al estudiar y aplicar el análisis, el diseño y la implementación de problemas centrados en el cliente. Los estudiantes adquieren experiencia en la realización de proyectos a escala empresarial y el desarrollo de las habilidades de comunicación oral y escrita necesarias para una carrera de administración exitosa.
    </p>
    <p>Los graduados de la Licenciatura en Ciencias en Gestión de Tecnologías de la Información estarán preparados para comenzar una carrera en informática o hacer la transición de técnicos informáticos a profesionales, supervisores o gerentes de tecnología de información.</p>
    <p>Comuníquese hoy con la División Latina de Keiser University para obtener más información sobre el programa de Licenciatura en línea en Licenciatura en Gestión de Tecnologías de la Información.</p>
